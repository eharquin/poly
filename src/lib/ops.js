...
export const STAT_SECTIONS = ['chordStats', 'pianoChordStats', 'guitarBuildStats', 'pianoBuildStats', 'fretboardNoteStats', 'fretboardFindStats', 'guitarRoleStats', 'pianoRoleStats', 'scaleStats', 'degreeToChordStats', 'degreeToSeventhStats', 'chordToDegreeStats']
