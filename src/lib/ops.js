...
export const STAT_SECTIONS = ['chordStats', 'pianoChordStats', 'guitarBuildStats', 'pianoBuildStats', 'guitarRoleStats', 'pianoRoleStats', 'scaleStats', 'degreeToChordStats', 'degreeToSeventhStats', 'chordToDegreeStats']
