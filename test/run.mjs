...
const files = ['./chords.test.mjs', './leitner.test.mjs', './degrees.test.mjs', './roles.test.mjs', './scales.test.mjs', './fretboard.test.mjs', './modes.test.mjs', './intervals.test.mjs', './keys.test.mjs']
let total = 0
