...
eq('roman et degré', DEGREE_CARDS.find((c) => c.id === 'G:V'), { id: 'G:V', key: 'G', tier: 1, root: 'D', acc: '', qual: 'maj', degree: 5, roman: 'V', seventh: false })
...
eq('paliers par armure : C 1, A 2, F# 3', ['C', 'A', 'F#'].map((k) => DEGREE_CARDS.find((c) => c.key === k).tier), [1, 2, 3])
